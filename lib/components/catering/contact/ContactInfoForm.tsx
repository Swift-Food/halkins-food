...
const fieldClass =
  "w-full bg-gray-50 border border-base-300 rounded-lg px-4 py-2.5 text-base text-base-content placeholder:text-base-content/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="col-span-full">
          <label className={fieldLabelClass}>
            Organization
            <span className="text-[9px] text-base-content/40 ml-2">
              (Optional)
            </span>
          </label>
          <input
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="col-span-full">
              ...
              <input
                ...
                className={`${fieldClass} ${
                  errors.billingAddress?.line1 ? "border-error" : ""
                }`}
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="City"
                className={`${fieldClass} ${
                  errors.billingAddress?.city ? "border-error" : ""
                }`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`${fieldClass} ${
                  errors.billingAddress?.postalCode ? "border-error" : ""
                }`}
              />
